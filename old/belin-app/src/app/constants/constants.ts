...
const constantData = [
    ...
    // Change Logs:
    { 
        key: 'en-US.Constant.ChangeLog.ChangeLog.0.1.15.5', 
        value: '0.1.15.5 - Google Protobuf reference, display latest change on jumbotron' 
    },
    { 
        key: 'en-US.Constant.ChangeLog.ChangeLog.0.1.15.4', 
        value: '0.1.15.4 - Minor style fixes' 
    },
    { 
    ...
    { 
        key: 'en-US.Constant.ChangeLog.ChangeLog.0.1.15.1', 
        value: '0.1.15.1 - Use ng module for adsense' 
    },
    { 
    ...
    { 
        key: 'en-US.Constant.ChangeLog.ChangeLog.0.1.14.3', 
        value: '0.1.14.3 - Fixed iframe resizing' 
    },
    { 
        key: 'en-US.Constant.ChangeLog.ChangeLog.0.1.14.2', 
        value: '0.1.14.2 - Improved logging to investigate issue' 
    },
    { 
    ...
    { 
        key: 'en-US.Constant.ChangeLog.ChangeLog.0.1.13.1', 
        value: '0.1.13.1 - Minor CSS upgrades' 
    },
    { 
    ...
    { 
        key: 'en-US.Constant.ChangeLog.ChangeLog.0.1.12.4', 
        value: '0.1.12.4 - Embedded content sends width' 
    },
    { 
